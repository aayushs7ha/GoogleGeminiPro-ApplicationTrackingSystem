...
def get_gemini_response(input,pdf_content,prompt):
    model=genai.GenreativeModel('gemini-pro-vision')
...
def input_pdf_setup(uploaded_file):
    if uploaded_file is not None:
        ...
        # First page -> content of entire pdf
        first_page = images[0]
        # Convert to bytes
...
input_prompt1 = """
You are an skilled ATS (Applicant Tracking System) scanner with a deep understanding in the field of data science, big data, full stack, data analyst and ATS functionality, 
